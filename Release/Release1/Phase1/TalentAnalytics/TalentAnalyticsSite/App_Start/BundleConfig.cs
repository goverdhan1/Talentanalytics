        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/bundles/vendorstyles").Include(
                ...
                "~/Content/toaster.min.css",
                 "~/App/core/styles/tod.header.css"
            ));
            ...
            bundles.Add(new StyleBundle("~/bundles/allpageStyles").Include(
               ...
               "~/App/summary/styles/summary.min.css",
               "~/App/certificationSummary/styles/certificationSummary.min.css",
               "~/App/detailedView/styles/detailedView.min.css",
               "~/App/detailedViewDataTable/styles/detailedViewDataTable.min.css",
               "~/App/detailedView/styles/detailedView.min.css",
               "~/App/compensationHistory/styles/compensationhistory.min.css",
