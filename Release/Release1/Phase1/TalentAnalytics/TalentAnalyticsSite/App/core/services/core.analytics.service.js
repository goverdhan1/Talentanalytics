    ...
    return {
        trackPage: function (pageName) {
            if (UserDetails.userId) {
                ...
                $rootScope.analyticsDataToSend = { pageName: pageName, title: 'Employee Quickview', userId: UserDetails.userId };
            } else {
                ...
                UserDetails.analyticsDataToSend = { pageName: pageName, title: 'Employee Quickview'};
            }
        }
    };
});