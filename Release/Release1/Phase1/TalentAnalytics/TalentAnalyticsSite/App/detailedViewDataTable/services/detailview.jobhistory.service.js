...
angular.module('detailedViewDataTable').factory('DetailedViewJobHistoryService', ['$resource', 'CoreConstants', function ($resource, CoreConstants) {

    var url = CoreConstants.baseHANAUrl + "Services/Employee_Quickview_Job_History_Details.xsodata/EMPLOYEE_QV_JOB_HISTORY_DETAILSParameters(IP_PGEPERSID=':employeeId')/Results?$format=json";
