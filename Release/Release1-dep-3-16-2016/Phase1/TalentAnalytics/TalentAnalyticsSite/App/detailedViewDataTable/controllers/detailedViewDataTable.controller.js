...
angular.module('detailedViewDataTable').controller('DetailedViewDataTableController', ['$scope', '$stateParams', 'DetailedViewActivityHistoryService',
    ...
    'DetailedViewEducationDetailsService', 'DetailedViewFWAHistoryService', 'UserPersonalizationService', 'DetailedViewCompensationHistoryService',
    'DetailedViewLOAHistoryService', 'DetailedViewCPAExamScoresService', 'CoreConstants', 'toaster', 'UserDetails', 'ExportData', '$q',
