...
describe('DetailedView DetailedViewService', function () {
    beforeEach(module('detailedView'));

    var DetailedViewService;
    var $resource;
    var $httpBackend;
    var $stateParams;
    var $state;
    var CoreConstants;
    var DetailedViewModel;

    it('Should be capable of returning data through the get protocol', function () {

        // Wrap the parameter in underscores
        beforeEach(inject(function (_$httpBackend_, _CoreConstants_, _DetailedViewModel_, _DetailedViewService_
            ) {
            $httpBackend = _$httpBackend_;
            CoreConstants = _CoreConstants_;
            DetailedViewModel = _DetailedViewModel_;
            DetailedViewService = _DetailedViewService_;
        }));
        ...
        DetailedViewService.get({ employeeId: employeeId }, function (response) {
